...
//const char* ssid = "Home";                   // edit your wifi SSID here
//const char* password = "244466666";            // edit your wifi password here
//
...
//"</head>" \
//"<body>" \
//"<H1><b>Ca nha ta cung thuong yeu nhau</b></H1>" \ 
//
//"<div id=\"container\">"\
...
<html lang=\"en\">\
  ...
  <body>\
          ...
          <h1>Input message</h1>\
          <input type='text' name='input_message' id='input_message' size=2 autofocus> \
          <div>\
